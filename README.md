...
饱和度（色度、纯度、彩度），并提供蒙版以避免鲜艳的像素值溢出，
以求比传统 HSV / HSL 更均衡、安全、符合感知的调整效果。
...
[![版本 1.3.0](https://img.shields.io/badge/版本-1.3.0-brightgreen)](https://github.com/GarthTB/OkSaturate/releases/latest)
